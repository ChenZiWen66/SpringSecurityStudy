...
import com.czw.webapp.controller.ValidateSmsContorller;
import com.czw.webapp.entity.SmsCode;
...
public class SmsCodeFilter extends OncePerRequestFilter {
    ...
    private void validateSmsCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        SmsCode codeInSession = (SmsCode) sessionStrategy.getAttribute(servletWebRequest, ValidateSmsContorller.SESSION_KEY_SMS_CODE + mobile);
        ...
        if (codeInSession.isExpire()) {
            sessionStrategy.removeAttribute(servletWebRequest, ValidateSmsContorller.SESSION_KEY_SMS_CODE + mobile);
